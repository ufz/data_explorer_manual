...
Finally, it is possible to switch on backface culling. This will result in rendering only triangles with normals directed towards the observer. It is as such a useful tool to check if all normals are set correctly on data sets. 
